  ...
  return (
    <main className="mx-auto w-full max-w-md px-5 py-8">
      ...
      <div className="text-ink-soft mt-6 space-y-5 text-[15px] leading-relaxed">
        <p>
          <b className="text-ink">신조어 판독기</b>는 최신 신조어 5문항과 레트로 유행어 5문항,
          총 10문항으로 내 <b className="text-ink">언어 나이</b>와 세대 라벨을 판독하는 재미
          진단이에요. 약 90초면 끝나고, 이름·생일 같은 개인정보는 필요 없어요.
        </p>
        <p>
          최신 밈을 잘 맞힐수록 언어 나이가 젊게, 그 시절 유행어를 잘 맞힐수록 지긋하게
          계산돼요. 몸의 나이와 다른, 내 말투와 밈 감각의 나이를 가볍게 확인하고 친구와 같은
          문제로 대결하는 것이 핵심 재미예요.
        </p>
        <p>
